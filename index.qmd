...
| Week     | Topic                                                                                              | Tools   |
+:=========+:===================================================================================================+:========+
| March 7  | [Pipes and functions](lecs/7-pipes-functions.pdf)                                                  |         |
+----------+----------------------------------------------------------------------------------------------------+---------+
| March 14 | [Functions, more functions and packages](lecs/08-functions-packages.pdf) & [Misc](lecs/9-misc.pdf) |         |
+----------+----------------------------------------------------------------------------------------------------+---------+
